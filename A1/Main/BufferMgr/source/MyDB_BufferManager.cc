...
MyDB_PageHandle MyDB_BufferManager :: getPage () {
	...
	if (got == pageTable.end()){
    	...
    	// create a page handle as well as read file from disk
    	pageHandle = make_shared<MyDB_PageHandleBase>(nullptr, pageId, this->pageSize, address, anonymousNextAvail);
		...
		// create a page handle pointing to the existing pageBase Object
    	pageHandle = make_shared<MyDB_PageHandleBase>(got->second->getPage(), pageId, this->pageSize, nullptr, anonymousNextAvail);
